...
const Home = ({ newbooks, statusnewbooks ,showbooknav, setshowbooknav , recommendbook , statusrecommend ,recommendbookrate , statusrecommendrate  }) => {
  ...
  return (
    <>
      ...
      <Navbarbook
        ...
        gridcount={gridcount}
        setgridcount={setgridcount}
        newbooks={recommendbookrate}
        loading={statusrecommendrate}
